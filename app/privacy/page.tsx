  ...
  return (
    <>
      ...
      <div className="">
        ...
        <div className="container rounded-[35px] bg-gray-200 shadow-md mt-10 mb-20">
          <div className=" font-inter mx-auto px-4 py-8">
            ...
            <p className="mb-4 text-[16px] font-inter">
              ...
              ascertained. This may include your name, address, e-mail address,
            ...
            <p className="mb-4 text-[16px] font-inter">
              ...
              P2P.com. We may also collect Personal Information about you from
              recordings of telephone conversations between us and you (or your
              representatives) and from publicly available registers.
            </p>
            <p className="mb-4 text-[16px] font-inter">
              Some of the Personal Information we collect is required by us to
              meet our legal and regulatory obligations (eg, information
              required to verify your identity). Otherwise, the Personal
              Information we collect is required in order for us to provide our
              services efficiently and effectively.
            </p>
            <p className="mb-4 text-[16px] font-inter">
              The types of Personal Information which we collect may include:
              your name; your photographic identification; your address; your
              phone number; your e-mail address; your banking details including
              account numbers; your date of birth; and information about your
              Transactions.
            </p>
            <p className="text-base mb-6">
            ...
            <h3 className="text-xl font-semibold mb-2">
              ...
              VPN services, TOR, or any other similar service. This is
            ...
            <p className="mb-4 text-[16px] font-inter">
              ...
              Users’ Personal Information with financial institutions or
              insurance companies as required for the purposes of the Company’s
              dealings with those institutions, and with other companies in the
              case of a merger, divestiture, or other corporate re-organization.
              We may share Users’ Personal Information with the Australian
              Securities Investments Commission, AUSTRAC, any financial dispute
              resolution scheme to which the Company subscribes, and other law
              enforcement bodies, regulatory agencies, courts, arbitration
              bodies and dispute resolution schemes, both in Australia and
              internationally, as may be required by law. If you request it in
              writing, we may share your Personal Information with your
              nominated advisers. Except where disclosure of your Personal
              Information is required by law or requested by you, we will
              generally require any third party which receives or has access to
              Personal Information to protect such Personal Information and to
              use it only to carry out the services they are performing for you
              or for us, unless otherwise required or permitted by law. We will
              ensure that any such third party is aware of our obligations under
              this Privacy Policy and we will take reasonable steps to ensure
              that contracts we enter with such third parties binds them to
              terms no less protective of any Personal Information disclosed to
              them than the obligations we undertake to you under this Privacy
              Policy or which are imposed on us under applicable data protection
              laws.
            </p>
            <h2 className="text-xl font-semibold mt-6 mb-4">
            ...
            <p className="mb-4 text-[16px] font-inter">
              ...
              email to us. The Company will act on your request only when it is
              not inconsistent with its legal and regulatory obligations and
            ...
            <p className="mb-4 text-[16px] font-inter">
              ...
              always object to processing the of your personal data, please ask
              us to restrict processing of your personal data or request a data
              export. Again, you can do so here or by contacting us. You have
            ...
            <p className="mb-4 text-[16px] font-inter">
              ...
              measures in place will, from time to time, be reviewed in line
              with legal and technical developments. However, we give no
              guarantee that such misuse, loss, unauthorised access,
            ...
            <p className="mb-4 text-[16px] font-inter">
              We are authorized to provide for the victim and the involved
              parties in case your account is related to fraudulent activities
              or legal violations.
            </p>
            ...
            <p className="mb-4 text-[16px] font-inter">
              ...
              responsible or liable for any of those third party sites,
            ...
            <p className="mb-4 text-[16px] font-inter">
              ...
              update, and block inaccurate and/or incorrect data. To exercise
              this right, contact us at contact@qunest.com. P2P will respond to
              ...
              for which it was used and to whom it was disclosed to in
            ...
            <p className="mb-4 text-[16px] font-inter">
              ...
              complaint about how your Personal Information has been used,
              please contact us in the first instance. If we cannot resolve your
