    ...
    <MainLayout>
      ...
      <div className="container rounded-[35px] bg-gray-200 py-10 shadow-md mt-32 mb-20">
        <div className="text-center">
          <h1 className="text-[32px] font-bold mb-4">Terms of Service</h1>
        ...
        <div className="ml-5 space-y-4 font-inter">
          ...
          <p>
            3. We reserve the right to change or modify the terms and conditions
            contained in the Terms, including but not limited to any policy or
            guideline of the platform, at any time and at our sole discretion.
            We will provide notice of these changes by posting the revised Terms
            and changing the "Last Revised" date at the top of the Terms, or by
            emailing users at their provided email addresses, or by any other
            means as determined by us at our sole discretion. Any changes or
            modifications will be effective immediately upon posting the
            revisions to the Website or at the instant that we transmit the
            information. These changes will apply at that instant to all then
            current and subsequent uses or Services.
          </p>
          <p>
          ...
          <p>
            ...
            conditions of any other agreement you may have with us for products,
          ...
          <p>
            ...
            electronic mail unless otherwise instructed. Documents will be sent
            to you by electronic mail and you should seek to send any documents
            to us by the same means.
          </p>
          <p>
            8. Any formal communication with you will, unless otherwise agreed,
            be made in the English language. In the event of any discrepancy
            between the English language version of the Terms or any such
            communications and any translation of the Terms or such
            communications (as applicable) in a foreign language, the respective
        ...
        <div className="ml-5 space-y-4 font-inter">
          <p>
            ...
            necessary rights and authorizations to bind such legal entity and to
            access and use the Services on behalf of such legal entity. Your use
            of the Services will not violate any and all laws and regulations
          ...
          <p>
            ...
            region under which the user belongs. As a result, if you do not meet
            these eligibility requirements, do not use our Services.
          </p>
        </div>
        <h2 className="text-[18px] font-rubik font-semibold mt-6 mb-2">
        ...
        <div className="ml-5 space-y-4 font-inter">
          <p>
            1. We retain the right to always keep an eye on your transactions or
            accounts that are connected to any of the following Prohibited
            Businesses, and any usage of our Services in conjunction with any of
            these types of endeavors is forbidden ("Prohibited Businesses").:
          </p>
          <ul className="list-disc pl-6 space-y-2">
            <li>
              unlicensed money service businesses, including but not limited to
              payment services providers, any money transmitter activities;
            </li>
            <li>
              ...
              activities or services that do not comply with any laws,
              regulations, or other legal authority applicable to us or
              applicable to the regulated financial services or activities in
              question.
            </li>
            <li>
              adult content and services, including but not limited to any types
              of pornography and other obscene materials (including literature,
              imagery and other media), sites offering any sexually-related
              services such as prostitution, escorts, pay-per view, and adult
              live chat features;
            </li>
            <li>deceptive marketing and false advertising services;</li>
            <li>religious and/or spiritual organizations;</li>
            <li>
              unlicensed sale of weapons of any kind, including but not limited
              to firearms, ammunition, knives, explosives, or related
              accessories;
            </li>
            ...
            <li>
              ...
              casino games, horse racing, dog racing, lotteries, games of
              chance, sweepstakes, games of skill that may be classified as
              gambling (i.e. poker), or other activities that facilitate any of
              the foregoing;
            </li>
            <li>
              money-laundering, fraud, terrorist financing, or any other type of
              financial crimes;
            </li>
            <li>
              any sort of Ponzi scheme, pyramid scheme, or multi-level marketing
              program;
            </li>
            <li>
            ...
            <li>
              wash trading, front-running, insider trading, market manipulation
              or other forms of market-based fraud or deceit;
            </li>
            <li>
            ...
            <li>
              any other unlawful activities which would, in our sole discretion,
              ...
              where we conduct business, or which would involve proceeds of any
              unlawful activities;
            </li>
            <li>
              Shell Banks or financial institutions that have customers that are
              Shell Banks;
            </li>
            ...
            <li>
              restricted financial services, including but not limited to credit
              repair, debt settlement, refinance, bail bonds, collections
              agencies; or
            </li>
            <li>
          ...
          <p>
            ...
            be a violation of these Terms and may suspend or terminate your
            account, and/or block transactions or freeze your funds immediately
            without notice, and we reserve the right to report any such
            suspected or actual Prohibited Businesses to the law enforcement
            authorities.
          </p>
        </div>
        <h2 className="text-[18px] font-rubik font-semibold mt-6 mb-2">
        ...
        <div className="ml-5 space-y-4 font-inter">
          <p>
            ...
            derivatives linked to Digital Assets or indices thereof. Buyers and
            sellers conduct trading on our platform with each other. In general,
            we as the platform provider are not a buyer or seller in these
            transactions. Users may request the withdrawal of their Digital
            Assets, subject to the limitations as stated in the Terms. Users
            will be able to access their Digital Assets in their wallets, which
            are held and safely kept by us.
          </p>
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>
              P2P – a Peer to Peer matching service, allowing users to exchange
              their Fiat Currency and Digital Assets with each other. Users are
              able to buy and sell Digital Assets from each other without the
              need of a centralized trusted third party such as an exchange;
            </li>
            <li>
            ...
            <li>
              Digital Wallet – a digital wallet, maintained by us on each user’s
              behalf, enabling each user to store any Digital Assets that are
          ...
          <p>
            4. You represent and warrant that you are the ultimate and effective
            legal and beneficial owner of any Digital Assets transferred to your
            account or wallet on the Website, that you shall not act as nominee
            or trustee for any other person and that you shall not transfer,
            assign, pledge, charge or otherwise create any security interest or
            encumbrance whatsoever over such Digital Assets.
          </p>
          <p>
            ...
            content or your inability to access the Website, for any delay in or
          ...
          <p>
            7. You acknowledge and consent that the Services are provided by us
            according to their current technological capacity and other
            ...
            to force majeure, virus, hacker attack, system instability, flaws in
            third-party services, acts of government, or government agency etc.
            that may result in service interruption, data loss and other losses
            and risks.
          </p>
          <p>
          ...
          <ol className="list-decimal pl-6 space-y-2">
            <li>
              ...
              reverse, any Digital Asset transaction or transfers or cancel
              abnormal transaction results in our sole discretion, even after
              funds may have been debited from your account(s) upon the
            ...
            <li>
              ...
              manipulation, market distortion or any other malicious wrongdoings
              to the market;
            </li>
            <li>
          ...
          <p>
            We also reserve the right to take actions, including but not limited
            to, close your accounts, limit trading, halt trading, cancel
            transactions, rollback transactions and return the relevant Digital
            Assets to any complainant so as to eliminate any adverse effects to
            the overall well-being of the market. In no event shall we be liable
            to you for any loss incurred when such action against you happens.
          </p>
          <p>
            ...
            Assets, as applicable. Accordingly, we shall not be responsible for
            any losses caused by your transmittal of funds or Digital Assets, as
            applicable.
          </p>
          <p>
          ...
          <p>
            ...
            problems of the Digital Asset networks or other force majeure. Users
            shall make sure to provide only correct information. We do not
            assume any responsibility for any losses caused by the
            aforementioned situations due to you providing incorrect information
            that results in our inability to reach out and to explain to you the
            handling procedures.
          </p>
          <p>
        ...
        <div className="ml-5 space-y-4 font-inter">
          <ol className="list-decimal pl-6 space-y-4">
            ...
            <li>
              ...
              their decisions are made on a well-informed basis, and they should
              undertake their own assessment as to the suitability of trading in
              Digital Assets in the light of their experience, objectives,
              financial resources and their specific needs and requirements.
            </li>
            <li>
        ...
        <div className="ml-5 space-y-4 font-inter">
          <ol className="list-decimal pl-6 space-y-4">
            ...
            <li>
              Protecting your Account: You agree to not enable anyone to use or
              direct your account, and to update us of any information change or
              if your account has been compromised. We will not be responsible
              for any liabilities, losses, or damages of any kind, whether
              direct or indirect, arising out of the unauthorized use of your
              Passwords. We will not be liable for any compensation or other
              legal liabilities for the loss or damage caused by you authorizing
              any third party or third-party platform to use your Passwords
              information.
            </li>
            <li>
              ...
              transfer costs of Fiat Currency or Digital Assets) associated with
              the closing of your account. In the event that the costs of
            ...
            <li>
              ...
              authority or role (“Your Account(s)”). Also, you agree that we can
              freeze/lock the funds and assets in Your Account(s) and suspend
              your access to the Website until a decision has been made if we
              suspect, in our sole discretion, any of the following:
              <ul className="list-disc pl-6 space-y-2 mt-2">
                <li>
                  You/Your Account(s) are or have been operated in violation of
                  any terms and conditions of these Terms;
                </li>
                <li>
                  You/Your Account(s) are or have been operated in violation of
                  any applicable laws or regulations in any applicable
                  jurisdiction(s);
                </li>
                <li>
                  You/Your Account(s) are or have been operated in violation of
            ...
            <li>
              ...
              right to terminate Your Account(s) at any time and for any reason
              at our sole discretion. You further agree and understand that we
              have the right to take any and all necessary and appropriate
              actions pursuant to these Terms, reasonable costs, and any
              applicable laws and regulations in any applicable jurisdiction(s).
            </li>
            <li>
              Effect of Suspension or Termination: We shall continue to maintain
              custody of all Digital Assets, funds, and information from such
              accounts, which may be turned over to any government or regulatory
              authority in the event that Your Account(s) was suspended or
              terminated pursuant to fraud investigations, investigations of
              violation of law, investigations of violation of these Terms, or
              court orders in any applicable jurisdiction(s).
            </li>
          </ol>
        </div>
        <h2 className="text-[18px] font-rubik font-semibold mt-6 mb-2">
        ...
        <div className="ml-5 space-y-4 font-inter">
          <ol className="list-decimal pl-6 space-y-4">
            <li>
              ...
              subject to the Terms, to access and use our Website and Services,
              solely for approved purposes as permitted by us. You agree that
              you will not copy, transmit, distribute, sell, license, reverse
              engineer, modify, publish, or participate in the transfer or sale
              of, create derivative works from, or in any other way, exploit any
            ...
            <li>
              ...
              <ul className="list-disc pl-6 space-y-2 mt-2">
                <li>
                  ...
                  property rights therein, are and shall remain with the
                  Parties;
                </li>
                <li>
        ...
        <div className="ml-5 space-y-4 font-inter">
          <ol className="list-decimal pl-6 space-y-4">
            ...
            <li>
              ...
              availability or accessibility of this Website; in connection with
              any illegal fund for payment and settlement including, but not
              limited to, payment by illegal means like fictitious transactions,
              false price, transaction refund and so on; illegal cash-out
              activity via entity bank settlement accounts; illegal fund
              transfer from the bank settlement account of an entity to an
        ...
        <div className="ml-5 space-y-4 font-inter">
          <ol className="list-decimal pl-6 space-y-4">
            ...
            <li>
              If you do not agree with any fees charged, you may stop using one
              or more of the Services immediately. You are still responsible for
              any fees incurred up to the date of termination of the Services.
            </li>
            <li>
        ...
        <div className="ml-5 space-y-4 font-inter">
          <ol className="list-decimal pl-6 space-y-4">
            ...
            <li>
              ...
              terminate the services provided to you without notice, temporarily
              or permanently, including, but not limited to, in the following
              cases:
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  If the personal information you have provided is not true,
                  complete, accurate, or is otherwise inconsistent with the
                  information provided at the time of registration and you have
                  failed to provide reasonable proof (please remember, according
                  to the laws and regulations you should submit true, complete
                  and accurate information);
                </li>
                <li>
                  If you violate the relevant laws and regulations in any
                  applicable jurisdiction(s), any terms and conditions of these
                  Terms, or additional terms and conditions applicable to your
                  use of particular Services as explained further in Clause 3;
                </li>
                <li>
                ...
                <li>
                  For security reasons or other necessary circumstances in order
                  to protect our legitimate business interests, among other
                  things, as determined at our sole discretion.
                </li>
              </ul>
            </li>
          </ol>
        ...
        <div className="ml-5 space-y-4 font-inter">
          ...
          <ul className="list-disc pl-6 space-y-2 ">
            ...
            <li>
              Deliver all assets as unclaimed property as it may be directed by
              the Competent Authorities or any court of competent jurisdiction.
            </li>
          </ul>
        </div>
        <h2 className="text-[18px] font-rubik font-semibold mt-6 mb-2">
        ...
        <div className="text-gray-700 space-y-6">
          <ul className="list-disc pl-6 space-y-2 ">
            <li>
              ...
              advisable that you consult your lawyer/professional tax adviser to
              determine your obligations and your tax status in your home
              jurisdiction.
            </li>
            <li>
              • Additionally, you agree to comply with all relevant laws of the
              Seychelles and any relevant laws and regulations in any other
              ...
              other agreements; collect amounts owed to us; or assist with an
              investigation or prosecution of suspected or actual illegal
              activity.
            </li>
            <li>
              When using our Services, you acknowledge, represent and undertake
              and agree that all your actions on and off this Site are made in a
              legal and proper manner and your sources of Digital Assets and
              fiat currency are not from illegal activities. If in our sole
              discretion we believe that You are in breach of the above
              representation and undertaking, we may discretionarily or in
        ...
        <div className="ml-5 space-y-4 font-inter">
          <ol className=" list-decimal pl-5">
            <li>
              ...
              users. We shall not be liable for errors that may occur during the
              process of acceptance of the Parties’ web service.
            </li>
            <li>
              Service Interruption: based on the special nature of the Internet,
              we do not guarantee that the service will not be interrupted. The
              timeliness and security of the service are also not guaranteed,
              and we do not bear the responsibility for any Service interruption
              which is not caused by us.
            </li>
            <li>
            ...
            <li>
              Accuracy, Completeness, and Reliability of the Website: unless we
              have expressly agreed in writing, we shall not guarantee the
              accuracy, completeness, reliability of any content, such as, but
              not limited to, advertising on the platform in any manner on this
              Website. We are not responsible for any products, services,
            ...
            <li>
              Announcements: in regards to notices issued to the users, we will
              deliver these notices through a formal page announcement, station
              letter, e-mail, customer service phone call, SMS or regular mail
              delivery. We do not bear any legal responsibility for any winning,
              discount activities or information which are delivered by other
              channels.
            </li>
            <li>
              Charges, Commissions, Transactions and Other Fees: we have the
              right to adjust the recharge, commission, transaction and other
              fees according to market conditions, and terminate any promotional
              efforts early.
            </li>
          </ol>
        </div>
        ...
        <div className="ml-5 space-y-4 font-inter">
          <ol className=" list-decimal pl-5">
            ...
            <li>
              ...
              thereto. No term or condition of any other document provided to us
              which is different from, inconsistent with, or in addition to the
              terms and conditions set forth herein will be binding upon the
              Parties. You represent and warrant that all information disclosed
              to us in connection with these Terms is true, accurate, and
              complete.
            </li>
          </ol>
        </div>
